...
<header id="header">
    ...
    echo Nav::widget([
        ...
        'items' => [
            ...
            ['label' => 'Profil', 'url' => ['/profile/index'],'visible'=> Yii::$app->user->can('readProfile')],
            ...
            [
    'label' => 'Contact',
    'url' => 'https://github.com/rendyirawann',
...
<footer id="footer" class="mt-auto py-3 bg-light">
    <div class="container">
        <div class="row text-muted">
            <div class="col-md-6 text-center text-md-start">&copy; RenDev <?= date('Y') ?></div>
